  ...
  return [
    {
      ...
      transform(code, id) {
        ...
        if (!normalizedId.includes('/packages/vueforge-layouts/src/') || !normalizedId.endsWith('.css')) {
          return null;
        }
    ...
    },
    {
      ...
      closeBundle() {
        ...
        const componentEntries: Array<[string, string, string, string[]]> = [
          ['container', 'VfContainer', './vueforge-layouts/src/primitives/VfContainer.vue', ['container.css']],
          ['stack', 'VfStack', './vueforge-layouts/src/primitives/VfStack.vue', ['stack.css']],
          ['inline', 'VfInline', './vueforge-layouts/src/primitives/VfInline.vue', ['inline.css']],
          ['section', 'VfSection', './vueforge-layouts/src/primitives/VfSection.vue', ['section.css']],
          ['grid', 'VfGrid', './vueforge-layouts/src/primitives/VfGrid.vue', ['grid.css']],
          ['app-shell', 'VfAppShell', './vueforge-layouts/src/shell/VfAppShell.vue', ['app-shell.css']],
          ['admin-layout', 'VfAdminLayout', './vueforge-layouts/src/shell/VfAdminLayout.vue', ['admin-layout.css']],
          ['admin-shell', 'VfAdminShell', './vueforge-layouts/src/shell/VfAdminShell.vue', ['admin-shell.css']],
          [
            'document-layout',
            'VfDocumentLayout',
            './vueforge-layouts/src/shell/VfDocumentLayout.vue',
            ['container.css', 'document-layout.css'],
          ],
          [
            'auth-layout',
            'VfAuthLayout',
            './vueforge-layouts/src/shell/VfAuthLayout.vue',
            ['container.css', 'auth-layout.css'],
          ],
          ['error-layout', 'VfErrorLayout', './vueforge-layouts/src/shell/VfErrorLayout.vue', ['error-layout.css']],
          [
            'setup-layout',
            'VfSetupLayout',
            './vueforge-layouts/src/shell/VfSetupLayout.vue',
            ['container.css', 'setup-layout.css'],
          ],
          ['header-area', 'VfHeaderArea', './vueforge-layouts/src/shell/VfHeaderArea.vue', ['header-area.css']],
          ['sidebar-area', 'VfSidebarArea', './vueforge-layouts/src/shell/VfSidebarArea.vue', ['sidebar-area.css']],
          ['content-area', 'VfContentArea', './vueforge-layouts/src/shell/VfContentArea.vue', ['content-area.css']],
          ['aside-area', 'VfAsideArea', './vueforge-layouts/src/shell/VfAsideArea.vue', ['aside-area.css']],
          ['footer-area', 'VfFooterArea', './vueforge-layouts/src/shell/VfFooterArea.vue', ['footer-area.css']],
        ];
        ...
        for (const [entryName, exportName, declarationSource, cssFiles] of componentEntries) {
          ...
          const typeExports =
            entryName === 'admin-layout'
              ? "export type { VfAdminLayoutExposed, VfAdminLayoutMobileSidebarScope, VfAdminLayoutMobileToggleAttrs, VfAdminLayoutProps, VfAdminLayoutScope } from './vueforge-layouts/src/shell/admin-layout.types';\n"
              : '';
          writeFileSync(
        ...
        : [
            ...
            dts({
              ...
              beforeWriteFile(filePath, content) {
                ...
                const dependencyImport = normalizedPath.endsWith('/vueforge-layouts/src/theme/types.d.ts')
                  ? '@codemonster-ru/vueforge-core'
                  : normalizedPath.endsWith('/vueforge-layouts/src/index.d.ts') ||
                      normalizedPath.endsWith('/vueforge-layouts/src/composables/useCssVarBreakpoints.d.ts')
                    ? '@codemonster-ru/vueforge-core/foundation'
                    : null;
