...
Current version: `@codemonster-ru/ui-tokens@2.0.0-dev.0` — in development, not published; the published line is `1.x`.
...
```bash
npm install @codemonster-ru/ui-tokens@^2.0.0-dev.0
```
