...
const sources = [
  ...
  { packageDirectory: 'css', path: 'components/admin-shell.css', export: './admin-shell.css' },
  { packageDirectory: 'css', path: 'components/alert.css', export: './alert.css' },
  { packageDirectory: 'css', path: 'components/app-shell.css', export: './app-shell.css' },
  ...
  { packageDirectory: 'css', path: 'components/document-layout.css', export: './document-layout.css' },
  ...
  { packageDirectory: 'css', path: 'components/icon.css', export: './icon.css' },
  ...
  { packageDirectory: 'css', path: 'components/setup-layout.css', export: './setup-layout.css' },
  ...
  { packageDirectory: 'css', path: 'components/table-of-contents.css', export: './table-of-contents.css' },
  { packageDirectory: 'css', path: 'components/tabs.css', export: './tabs.css' },
  { packageDirectory: 'css', path: 'components/tag.css', export: './tag.css' },
  { packageDirectory: 'css', path: 'components/theme-switch.css', export: './theme-switch.css' },
