...
test('probes showcase readiness in a way both application shells satisfy', () => {
  ...
  // The reference commit renders VfAppShell; the current showcase renders a native shell.
  assert.match(capture, /const showcaseContentReady =\s/u);
  assert.match(capture, /document\.querySelector\("#app"\)\?\.children\.length > 0/u);
